...
class TriangleMeshSlicer
{
    ...
    ~TriangleMeshSlicer();
    void slice(std::vector<float> &z, std::vector<Polygons>* layers) const;
    void slice(std::vector<float> &z, std::vector<ExPolygons>* layers) const;
    ...
    void _slice_do(size_t facet_idx, std::vector<IntersectionLines>* lines, boost::mutex* lines_mutex, const std::vector<float> &z, const std::vector<int> &layers_indexes) const;

...
/*This is necessary, otherwise sources that include xsinit.h will choke on allocation_schemes.hpp.
Weird, since sources that include allocation_schemes.hpp but not xsinit.h will compile just fine.*/
